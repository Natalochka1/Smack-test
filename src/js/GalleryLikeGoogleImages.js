...
var Grid = (function() {
	...
	function showPreview( $item ) {
		...
		var preview = $.data( this, 'preview' ),
			...
			// $(".preview-item").last().css('height', $item.data( 'height' )*2.5);
	...
	function hidePreview() {
		...
		$(".preview-item").css('height', 0);
		// for (var i = 0; i < $('.preview-item').length; i++) {
		// 	$('.preview-item').eq(i).css('height', 0); 	
		// 	}
	...
	Preview.prototype = {
		create : function() {
			...
			this.$href = $( '<a href="#" class="btn">View Live</a>' );
			...
			this.$item.prevAll("li.preview-item:first").append(this.getEl());
		...
		close : function() {
			...
			setTimeout( $.proxy( function() {
				...
				this.$previewEl.parent().css( 'height', 0 );
